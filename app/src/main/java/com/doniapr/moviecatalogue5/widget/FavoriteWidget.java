...
public class FavoriteWidget extends AppWidgetProvider {
    public static final String TOAST_ACTION = "com.doniapr.moviecatalogue5.widget.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.doniapr.moviecatalogue5.widget.EXTRA_ITEM";
